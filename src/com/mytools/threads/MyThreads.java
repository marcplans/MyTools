package com.mytools.threads;

public class MyThreads {

	public static void main(String[] args) {

		// Create a runnable object and override
		// run method in anonymous class
        ...
        // Create and start a second thread using the runnable 
        // object with lambda notation and not given a name
